...
namespace RemoveNames
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //first list of names            
            Console.WriteLine("Input the first list of names seperated by a space(\" \")");
            ...
            Console.WriteLine("Input the second list of names seperated by a space(\" \")");
            ...
            //list of names that do not match in both other lists
